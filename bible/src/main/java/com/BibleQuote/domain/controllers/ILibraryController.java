...
public interface ILibraryController {
    IBookController getBookCtrl();

    IChapterController getChapterCtrl();

    LibraryContext getContext();

    IModuleController getModuleCtrl();

    com.BibleQuote.domain.controllers.modules.IModuleController getModuleCtrl(Module module);
}
