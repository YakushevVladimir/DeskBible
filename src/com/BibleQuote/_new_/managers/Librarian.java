...
public class Librarian {
	...
	private FsModuleController fsModuleController;
	...
	public Librarian(Context context) {
		...
		if (cacheController.isCacheExist(moduleCache)) {
			...
			fsModuleController.loadModulesAsync();
		} else {
			fsModuleController = new FsModuleController(context, libraryPath, eventManager);
			modules = fsModuleController.loadModules();
